...
{{--                not too big to recognize you and we are not too small to serve and be served by you.</p>--}}
        ...
        <div class="col-md-6 d-flex">
          <div class="img img-video d-flex align-self-stretch align-items-center justify-content-center justify-content-md-center mb-4 mb-sm-0" style="background-image:url( {{ asset('images/ministry-4.jpg') }}); border-radius: 10px;">
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="services-2">
            ...
            <div class="text">
              ...
              <span class="subheading">Contact Members</span>
                Whether you are trying church for the first, coming back to church after a long time, or trying to find a new church, we realize you probably have a lot of questions. Hopefully, this
                page helps. Feel free reach out at any time.
                <span class="content1">
                    We’d love to get to know you. We know there are a lot of questions you like to get answers to as a visitor who is trying to connect with Revelation City Church for the first
          ...
          <div class="services-2">
            ...
            <div class="text">
              ...
              <span class="subheading">Beliefs and History</span>
                Our passion is to see lives transformed, faith renewed, and God’s love expressed through the teaching and preaching of the undiluted Word of God as well as through our social service
                engagement with the community.
                <span class="content2">
                  God’s love towards us is incredibly amazing that it requires nothing from us than to just believe in what He did perfectly for us on the cross to take
          ...
          <div class="services-2">
            ...
            <div class="text">
              ...
              <span class="subheading">What to expect</span>
                ...
                with you by inviting
                <span class="content3">
                  and bringing friends and families along with you. You are blessed so that your life can be a channel of blessings to others in your community. We encourage you
      ...
      <div class="item ftco-animate">
        ...
        <div class="blog-entry align-self-stretch">
          ...
          <div class="text p-3" style="background: #ffffff;">
            ...
            <p style="text-overflow: ellipsis;"> It is good as it is now, we can be updating it on a weekly basis depending on the theme for the month/series and topic for the week. But it should connect to contact page
    ...
    <div class="container">
      ...
      <div style="background: #f6f6f9; border-radius: 20px; padding: 5px 20px">
        <div class="row justify-content-right text-center">
            ...
            @foreach($sermons as $sermon)
              ...
              <div class="col-md-4 text-left ftco-animate">
                <a href="{{  $sermon->filepath }}" class="px-4 py-3 ml-lg-2 popup-vimeo">
                  <video poster="{{ asset('images/play2.png')}}" src="{{ $sermon->filepath }}" class="img block-10" style="padding: 5px; background-image: url( {{ asset('images/welcome.jpg') }});
        ...
        <p class="my-5 text-center"> <a href="/sermons" class="btn btn-primary py-2 mb-2 px-2 px-md-4"> View More Sermon </a></p>
          ...
          @else
              <h2 class="my-5 text-center">Empty!!!!!!!!!!!!!!!!!!!!!</h2>
          @endif
      </div>
    ...
    <div class="container">
      <div class="row justify-content-center pb-5">
        <div class="col-md-10 heading-section heading-section-white text-center ftco-animate">
          ...
          <p class="mb-0 mt-5	"> <a href="donate" class="btn btn-primary py-3 px-2 px-md-4" style="border-radius: 10px;"> Donate Online </a></p>
      ...
      <div class="row">
          @if(count($events) > 0)
            ...
            <div class="col-md-12 event-wrap d-md-flex ftco-animate">
              ...
              @endforeach
          @else
              <h2 class="my-2 text-center">Empty!!!!!!!!!!!!!!!!!!!!!</h2>
          @endif
      </div>
    </div>
  </section>
      ...
      <div class="row no-gutters justify-content-center pb-5 mb-3">
        ...
        <form action="{{ route('gallery.store') }}" method="POST" enctype="multipart/form-data">
          <div class="text-center ftco-animate">
            ...
            <p class="mb-0"> <button type="submit" class="btn btn-primary py-2 mb-2 px-2 px-md-4"> Add new Gallery </button></p>
          </div>
        </form>
        @endif
