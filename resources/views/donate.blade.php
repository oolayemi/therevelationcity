    ...
    <div class="container">
      ...
      <div class="row no-gutters d-flex sermon-wrap ftco-animate bg-light">
        <div class="col-md-6 d-flex align-items-stretch ftco-animate">
          <a href="#" class="img m-3" style="background-image: url(images/Giving.jpg);"></a>
        </div>
                    ...
                    <div class="ftco-animate beliefs">
                        ...
                        <ul>
                            ...
                            <li> Giving financially is a great way to get behind this vision and support the work of God in the Church. If you are regular at Revelation City or visiting, kindly
                                prayerfully consider what you can contribute - everything you give goes into making this vision a reality and quite literally helps transform lives FOREVER.</li>
                ...
                <div class="pt-md-1 mx-4 mb-4 text-left">
                    ...
                    <div class="ftco-animate beliefs">
                        ...
                        <p class="text-left ftco-animate">
                            Each of us should also consider how much and how to GIVE. "So, let each one GIVE as he PURPOSES in his heart, not GRUDGINGLY or of NECESSITY; for God loves a CHEERFUL giver"
        ...
        <div>
            <div class="heading-section pt-md-5 pb-3">
                <h2 class=" text-center ftco-animate">OUR BELIEFS</h2>
                <ul>
                    <li class="ftco-animate">On a Sunday, you can give TITHES, OFFERINGS or donate to a specific ministry in the Church by CASH, CARD or CHEQUE (payable to "Revelation City Church) using our envelopes
                        .</li>
                    ...
                    <li class="ftco-animate">You can donate online by using the DONATE ONLINE button at the on the Church website - www.therelationcity.org. which attracts certain percentage charge fees on the amount
                        donated</li>
                </ul>
