...
@include('helpers.sociallinks')
      ...
      <div class="row no-gutters slider-text align-items-end">
        <div class="col-md-9 ftco-animate pb-5">
          <p class="breadcrumbs mb-2"><span class="mr-2"><a href="/">Home <i
                  ...
                  class="fa fa-chevron-right"></i></a></span> <span> Call Ministry <i
                class="fa fa-chevron-right"></i></span></p>
          <h1 class="mb-0 bread">Call Ministry</h1>
        </div>
      </div>
    </div>
  </section>
  <section class="ftco-section ftco-degree-bg">
    <div class="container">
      <h2 class="mb-4 text-center text-bold">Call Ministry</h2>
      <div class="row">
        <div class="col-lg-8 ftco-animate">

            <p>
                <img src="images/call-ministry.jpg" alt="" style="border-radius: 10px;" class="img-fluid ftco-animate">
            </p>
          ...
          <div class="mt-4 ftco-animate">
            <h5><span class="ftco-animate text-bold"> Revelation Army </span></h5>
            <p class="ftco-animate">Revelation Army is a prayer arm of Revelation City. They stand in the gap as spiritual
              ...
              used as vessels; we seek not only personal transformation, but the transformation of the world as well.
              He invites us into a more intimate relationship with Him, and with others, and into a place of
              intercession
              where we discover that burden of the Lord is light and His yoke is easy; a place where creative expression
              abounds,
              spiritual gifts are released, faith grows and the body of Christ is empowered.</p>
          </div>

          <div class="mt-4 ftco-animate">
            <h5><span class="ftco-animate text-bold"> Evangelism and Follow Up Team </span></h5>
            <p class="ftco-animate"> One of the assignments of Revelation Army is to pray for the Lord of harvest to send
              laborers and
              bring in the harvest. The duty of the Evangelism and Follow up Team is to go into the field to bring in
              the harvest
              through different strategic evangelism methods. The great commission encourages everyone to Go and make
              disciples of all
              nations. Jesus said that not only is it important for us to bear fruits, we must ensure that our fruits
              abides.
              The team evangelizes to people outside with the gospel of Christ and follow up all the converts and
              prospective ones
        ...
        <div class="col-lg-4 sidebar pl-lg-5 ftco-animate">
          <div class="sidebar-box ftco-animate">
            ...
            <div class="block-21 mb-4 d-flex ftco-animate">
              ...
              <div class="text">
                <h3 class="heading mb-1"><a href="/creative-ministry"> CREATIVE MINISTRY </a></h3>
                <p>Creative ministry embodied all the service units in music, entertainm..... </p>
              </div>
            </div>
