...
@include('helpers.sociallinks')
      ...
      <div class="row no-gutters slider-text align-items-end">
        <div class="col-md-9 ftco-animate pb-5">
          <p class="breadcrumbs mb-2"><span class="mr-2"><a href="/">Home <i
                  ...
                  class="fa fa-chevron-right"></i></a></span> <span> Hospitality Ministry <i
                class="fa fa-chevron-right"></i></span></p>
          <h1 class="mb-0 bread">Hospitality Ministry</h1>
        </div>
      </div>
    </div>
  </section>
  <section class="ftco-section ftco-degree-bg">
    <div class="container">
      <h2 class="mb-4 text-center text-bold">Hospitality Ministry</h2>
      <div class="row">
        <div class="col-lg-8 ftco-animate">

          <p>
            <img src="images/hospitality.jpg" alt="" style="border-radius: 10px;" class="img-fluid">
          </p>
          <h5 class="mt-3 ftco-animate">Hospitality ministry embodied all the service units that are centered
            on friendly, generous reception and entertainment of guests, visitors, and regular members.
