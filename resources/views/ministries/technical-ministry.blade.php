...
@include('helpers.sociallinks')
      ...
      <div class="row no-gutters slider-text align-items-end">
        <div class="col-md-9 ftco-animate pb-5">
          <p class="breadcrumbs mb-2"><span class="mr-2"><a href="/">Home <i
                  ...
                  class="fa fa-chevron-right"></i></a></span> <span> Technical Ministry <i
                class="fa fa-chevron-right"></i></span></p>
          <h1 class="mb-0 bread">Technical Ministry</h1>
        </div>
      </div>
    </div>
  </section>
  <section class="ftco-section ftco-degree-bg">
    <div class="container">
      <h2 class="mb-4 text-center text-bold">Technical Ministry</h2>
      <div class="row">
