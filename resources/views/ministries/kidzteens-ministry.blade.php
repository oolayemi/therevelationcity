...
@include('helpers.sociallinks')
      ...
      <div class="row no-gutters slider-text align-items-end">
        <div class="col-md-9 ftco-animate pb-5">
          <p class="breadcrumbs mb-2"><span class="mr-2"><a href="/">Home <i
                  ...
                  class="fa fa-chevron-right"></i></a></span> <span> KIDZ & TEENS Ministry <i
                class="fa fa-chevron-right"></i></span></p>
          <h1 class="mb-0 bread">KIDZ & TEENS Ministry</h1>
        </div>
      </div>
    </div>
  </section>
  <section class="ftco-section ftco-degree-bg">
    <div class="container">
      <h2 class="mb-4 text-center text-bold">KIDZ & TEENS Ministry</h2>
      <div class="row">
        <div class="col-lg-8 ftco-animate">

          <p>
            <img src="images/kidz_teens.jpg" alt="" style="border-radius: 10px;" class="img-fluid ftco-animate">
          </p>
          <h5 class="mt-3 ftco-animate">Kids and Teens Ministry is a service unit that is centered
            around building and equipping the next generation. This team requires those
